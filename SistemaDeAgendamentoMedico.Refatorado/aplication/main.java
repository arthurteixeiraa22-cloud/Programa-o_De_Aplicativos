package SistemaDeAgendamentoMedico.Refatorado.aplication;

import SistemaDeAgendamentoMedico.Refatorado.entities.Consulta;
import SistemaDeAgendamentoMedico.Refatorado.entities.Paciente;
...
public class main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < pacientes.length; i++) {
            ...
            if (pacientes[i] != null
                    && pacientes[i].getCPF().equals(CPF)
                    && pacientes[i].getNomePaciente().equalsIgnoreCase(nome)) {
